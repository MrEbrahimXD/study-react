...
function globalNavDropdowns(e)
{
    ...
    this.container = document.querySelector(e);
        ...
        .querySelector(".navRoot");
    
    this.primaryNav = document.querySelector(e)
        .querySelector(".navRoot")
        .querySelector(".navSection.primary");
    this.primaryNavItem = document.querySelector(e)
        .querySelector(".navRoot")
        .querySelector(".navSection.primary .rootLink:last-child");
    this.secondaryNavItem = document.querySelector(e)
        .querySelector(".navRoot")
        .querySelector(".navSection.secondary .rootLink:first-child");
    this.checkCollision();
    ...
    this.dropdownSections = Strut.queryArray(".dropdownSection", this.container)
        .map(function (e)
        {
            return {
                el: e,
...
}), document.addEventListener("DOMContentLoaded", function ()
{
    ...
    positionSticky: (function ()
    {
        ...
        return (r.cssText = e + i.join(t + ";" + e)
            .slice(0, -e.length)), r.position.indexOf(t) !== -1;
    })(),
    masks: (function ()
    {
